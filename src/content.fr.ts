// Toute la copie du site (français). Les textes sont repris tels quels — ne
// pas reformuler sans validation éditoriale. Miroir exact de content.en.ts :
// mêmes clés, même structure.

export const content = {
  meta: {
    title: 'Shifatek — Santé digitale et innovation',
    description: "Shifatek conçoit des outils de santé digitale pour l'Afrique de l'Ouest.",
  },
  ...
  chatTopics: [
    {
      ...
      link: { label: 'En savoir plus', href: '/#mission' } as { label: string; href: string } | undefined,
    },
    {
      id: 'aphia',
      ...
      link: { label: 'Découvrir APHIA Care', href: '/aphia' } as { label: string; href: string } | undefined,
    },
    {
      id: 'ilmia',
      ...
      link: { label: 'Découvrir Ilmia', href: '/ilmia' } as { label: string; href: string } | undefined,
    },
    {
      id: 'formations',
      ...
      link: { label: 'Découvrir les formations', href: '/formations' } as { label: string; href: string } | undefined,
    },
    {
      id: 'contact',
      ...
      link: { label: 'Ouvrir le formulaire', href: '/#contact' } as { label: string; href: string } | undefined,
    },
    {
      id: 'location',
