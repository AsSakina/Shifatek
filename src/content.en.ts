  ...
  chatTopics: [
    {
      ...
      link: { label: 'Learn more', href: '/#mission' } as { label: string; href: string } | undefined,
    },
    {
      id: 'aphia',
      ...
      link: { label: 'Discover APHIA Care', href: '/aphia' } as { label: string; href: string } | undefined,
    },
    {
      id: 'ilmia',
      ...
      link: { label: 'Discover Ilmia', href: '/ilmia' } as { label: string; href: string } | undefined,
    },
    {
      id: 'formations',
      ...
      link: { label: 'Discover our training', href: '/formations' } as { label: string; href: string } | undefined,
    },
    {
      id: 'contact',
      question: 'How can I contact you?',
      answer: 'The simplest way is the contact form, or email us directly at contact@shifatek.com. We reply quickly.',
      link: { label: 'Open the form', href: '/#contact' } as { label: string; href: string } | undefined,
    },
    {
      id: 'location',
